#!/usr/bin/env node
/**
 * Generates every brand asset for Multitick from one source of truth: the mark below.
 *
 ...
 */
const SHAPES = [{"type":"ring","cx":0.5,"cy":0.54,"r":0.36,"w":0.1,"fill":"accent"},{"type":"rect","x":0.44,"y":0.04,"w":0.12,"h":0.09,"r":0.03,"fill":"accent"},{"type":"path","points":[[0.5,0.54],[0.5,0.3]],"w":0.075,"fill":"accentLight"},{"type":"path","points":[[0.5,0.54],[0.7,0.62]],"w":0.075,"fill":"accentLight"},{"type":"circle","cx":0.5,"cy":0.54,"r":0.055,"fill":"accentLight"}];
 ...
 */
const MARK = [[0.12,1,1,1,0.12],[1,0.12,1,0.12,1],[1,0.12,1,1,1],[1,0.12,0.12,0.12,1],[0.12,1,1,1,0.12]];
...
console.log('Generating Multitick brand assets\n');
