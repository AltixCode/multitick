...
`apps.json`). Fix it there and re-run `node scripts/bootstrap.mjs multitick`,
...
| | |
|---|---|
| Bundle id / package | `com.altixcode.multitick` |
| Scheme | `multitick://` |
| RevenueCat entitlement | `remove_ads` |
| RevenueCat package | `$rc_lifetime` |
| iOS product | `com.altixcode.multitick.removeads` |
| Android product | `remove_ads` |
| GitHub | `AltixCode/multitick` |
